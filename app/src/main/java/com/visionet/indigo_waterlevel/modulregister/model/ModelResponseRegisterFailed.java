...
public class ModelResponseRegisterFailed {

	/**
	 * result : null
	 * targetUrl : null
	 * success : false
	 * error : {"code":0,"message":"Your request is not valid!","details":"The following errors were detected during validation.\r\n - The EmailAddress field is required.\r\n - The EmailAddress field is not a valid e-mail address.\r\n","validationErrors":[{"message":"The EmailAddress field is required.","members":["emailAddress"]},{"message":"The EmailAddress field is not a valid e-mail address.","members":["emailAddress"]}]}
	...
	public static class ErrorBean {
		...
		public static class ValidationErrorsBean {
			/**
			 * message : The EmailAddress field is required.
